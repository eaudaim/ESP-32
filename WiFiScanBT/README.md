Scan wifi AP and return SSID and RSSI for each network found, on a bluetooth serial port, also return a number for the type of encryption : TKIP (WPA)= 2, WEP= 5, CCMP (WPA)= 4, NONE= 7, AUTO= 8
